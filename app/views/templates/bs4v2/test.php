<?php
		...
		$pageconfig['num_results']=1;//default set to 10
		...
		if($this->bs4pagination_model->total_records == 0){
			return;
		}
		$results=$this->bs4pagination_model->results;
		$currentpage=$this->bs4pagination_model->page_links;
		$totalrecords=$this->bs4pagination_model->total_records;
