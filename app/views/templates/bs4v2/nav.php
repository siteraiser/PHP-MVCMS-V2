<div class="nav-bar"><input type="checkbox" class="hider hidden-sm-up" id="hider" value="1"><label for="hider" id="hider-label">&nbsp;</label>
	<div class="container">
	<nav class="">
 ...
 <a class="navbar-brand" href="/">
  ...
  <form class="form-inline pull-xs-right" name="search" method="get" action="/search">
    <input class="form-control" name="search" type="text" placeholder="Search"><button class="btn btn-danger-outline" type="submit">Search</button>
  </form>
  </div>
</nav>
</div>
